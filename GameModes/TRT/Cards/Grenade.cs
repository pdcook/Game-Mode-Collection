...
namespace GameModeCollection.GameModes.TRT.Cards
{
    ...
    {    
        ...
        {
            return "A standard fragmentation grenade. Press [item 5] to throw it.";
        }
    ...
    public class A_Grenade : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                used = true;
                GameModeCollection.instance.StartCoroutine(GrenadeHandler.MakeGrenadeHandler(this.Player.playerID, ThrowSpeed * this.Player.data.weaponHandler.gun.shootPosition.forward, this.Player.data.weaponHandler.transform.position, Quaternion.identity));
