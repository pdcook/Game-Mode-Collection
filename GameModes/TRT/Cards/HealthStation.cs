    ...
    internal class A_HealthStation : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (!HasPlaced && this.Player.data.playerActions.ItemWasPressed(1))
            {
                ...
                NetworkingManager.RPC(typeof(A_HealthStation), nameof(RPCA_RemoveCardFromPlayer), this.Player.playerID);
        ...
        private static void RPCA_RemoveCardFromPlayer(int playerID)
        {
            ...
            ModdingUtils.Utils.Cards.instance.RemoveCardFromPlayer(player, HealthStationCard.Card, ModdingUtils.Utils.Cards.SelectionType.Oldest, false);
        }
    }
}
